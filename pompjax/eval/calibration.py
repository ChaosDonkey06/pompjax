...
def calibration(samples, observation, observation_index=None, quantiles=[0.25, 0.5, 0.75, 0.95], resample="D", dates=None):
    """_summary_
    ...
    T, k, m = samples.shape # T: simulation length, k: number of observations, m: number of samples/ensembles
